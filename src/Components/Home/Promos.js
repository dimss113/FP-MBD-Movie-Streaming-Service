      ...
      <div className='lg:grid lg:grid-cols-2 lg:gap-10 items-center'>
        <div className='flex lg:gap-10 gap-6 flex-col'>
          ...
          <p className='text-text text-sm xl:text-base leading-6 xl:leading-8'>
            ...
            exercitationem quae voluptatibus quidem dolorum. Quisquam voluptatum,
            quibusdam, quos, voluptate voluptas quia quod exercitationem quae
          </p>
        ...
        <div className=''>
          ...
          <Link to='/subscribe' className='bg-subMain hover-text-main transitions text-white px-8 py-3 rounded font-medium sm:text-sm text-xs'>
            Subscribe Now
          </Link>
        </div>
      </div>
